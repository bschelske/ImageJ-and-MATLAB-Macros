function skimgrinchscriptrsq20221017(petdetcsvpath, intdenpath, nChambers, isLog, isHisto, isMultiplot, isCellplot)
...
%         f1 = tiledlayout(8,20);
        ...
        for nChamber=1:nChambers
    		nexttile;
            nChamberIntensities = backroundSubtractedArray(:,nChamber);
