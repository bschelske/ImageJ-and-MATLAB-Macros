function createfigure(X1, Y1, Size1, Color1)
...
%  Auto-generated by MATLAB on 14-Jun-2022 12:20:27
% Create figure
figure1 = figure;
% Create axes
...
hold(axes1,'on');
% Create scatter
scatter1 = scatter(X1,Y1,Size1,Color1,'DisplayName','data1','Marker','*');
% Get xdata from plot
...
% Plot the fit
fitLine1 = plot(xplot1,yplot1,'DisplayName','   cubic','XLimInclude','off',...
    'Tag','cubic',...
    'Parent',axes1,...
    'MarkerSize',6,...
...
set(legend1,...
    'Position',[0.709523811599328 0.61150793877859 0.160714283638767 0.0869047596341087]);
%-------------------------------------------------------------------------%
